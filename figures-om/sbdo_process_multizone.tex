...
\tikzset{
	...
	container/.style={draw, rectangle, dashed, inner sep=0.5cm, rounded corners, fill=yellow!20, minimum height=4cm},
	subcontainer/.style={draw, rectangle, inner sep=0.15cm, rounded corners, fill=red!30, minimum height=6.5em},
...
%\coordinate [font=\fontsize{10}{0}\selectfont] (initCoord) at ([yshift=-5mm]optSel.south);
\node % Initialize optimization
[whtblock,  yshift=-5mm, below left=of optSel.south, text width=6em, font=\fontsize{10}{0}\selectfont] 
(init) 
{Initialization};

\node % Optimization parameter selection
[whtblock, yshift=-5mm, below right=of optSel.south, text width=6em, font=\fontsize{10}{0}\selectfont] 
(parSel) 
{Select algorithm parameters};

\node % Execute optimizaiton
[whtblock, yshift=-5mm, below=of $(init)!0.5!(parSel)$, font=\fontsize{10}{0}\selectfont] 
(optExct) 
...
\begin{pgfonlayer}{behind}
	...
	\node [container, fit=(aux1) (id) (DVs) (OFs) (SAMs), font=\fontsize{10}{0}\selectfont] (initialDesign) {};
...
\begin{pgfonlayer}{background}
	\coordinate [font=\fontsize{10}{0}\selectfont] (sc1) at (init.north);
	\node [subcontainer, fit=(sc1) (init) (parSel), font=\fontsize{10}{0}\selectfont] (optSetup) {};
	\node at (optSetup.north) [fill=blue!10, draw, rounded corners, font=\fontsize{12}{0}\selectfont] (optSetup-label) {\textbf{Optimization Setup}};
\end{pgfonlayer}
...
\path [line] (optSel) -- (optSetup-label.north);
\path [line] (optSetup) -- (optExct);
